...
Owl Carousel 2 : Touch enabled WordPress plugin that lets you create a beautiful responsive carousel owl. Also work with Gutenberg shortcode block.

== Description ==

> Important Recommendations : For better user experience we have shifted  **Owl Carousel 2 Ultimate** plugin in our to new plugin ie [SlidersPack – All In One Image/Post Slider](https://wordpress.org/plugins/sliderspack-all-in-one-image-sliders/). It help us to maintain our all slider plugins in a single plugin package and provide you better and fast support.  
...
= 1.4 (25 May 2019) =
* [*] Important Recommendations : For better user experience we have shifted  "Owl Carousel 2 Ultimate" plugin in our to new plugin ie "SlidersPack – All In One Image/Post Slider". It help us to mantain our all slider plugins in a single plugin package and provide you better and fast support.
